...
/*   Updated: 2017/10/18 14:21:46 by agfernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		start_wolf(t_env *env)
{
	...
	MLX.imgchar = mlx_get_data_addr(MLX.image, &(MLX.mlximgbpp), &(MLX.mlximgsize), &(MLX.mlximgendian));
	mlx_put_image_to_window(MLX.mlx, MLX.win, MLX.imgchar, 0, 0);
	printf("ok1\n");
